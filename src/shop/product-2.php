            ...
            <div class="product__row flex flex-wrap">
              <div class="col-sm-100 w-1/2 lg:w-2/5">
                <div class="product__view px-5 py-5">
                  <img src=<?php $_SESSION['img'] = "../../images/new-2.jpg"; echo $_SESSION['img']; ?> 
                    alt= <?php $_SESSION['alt'] = "costa rica san pedro"; 
                ...
                <div class="product__detail px-5 py-5">
                  <div class="product__title">
                    ...
                    <h2 class="heading-secondary text-5xl md:text-6xl font-semibold">
                      <?php
                        $_SESSION['product'] = 'Costa Rica San Pedro';
              ...
              <div class="col-sm-100 w-1/2 lg:w-2/5 order-1">
                <div class="product__desc px-5 py-5">
                  ...
                  <p class="product__desc--para mt-5 ">
                    A leader in the micro-mill revolution, Costa Rica has transformed its production structure over the past decade, shifting from co-ops and larger private mills to smallholder-owned micro-mills. This vertical integration has enabled small producers to add value through improved quality and individualization, while also reaching new markets. We are excited to work with one of these exemplary producers for the second year, Daniela Gutierrez. Succeeding last year's El Mango lot, we are welcoming another Gutierrez farm, San Pedro.
                  </p>
                </div>
              </div>
