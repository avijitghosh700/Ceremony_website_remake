            ...
            <div class="product__row flex flex-wrap">
              <div class="col-sm-100 w-1/2 lg:w-2/5">
                <div class="product__view px-5 py-5">
                  <img src=<?php $_SESSION['img'] = "../../images/new-8.jpg"; echo $_SESSION['img']; ?> 
                    alt=<?php $_SESSION['alt'] = "Ethiopia Chelchele"; 
              ...
              <div class="col-sm-100 w-1/2 lg:w-3/5">
                <div class="product__detail px-5 py-5">
                  <div class="product__title">
                    <p class="heading-sub uppercase">yirgacheffe</p>
                    <h2 class="heading-secondary text-5xl md:text-6xl font-semibold">
                      <?php
                        $_SESSION['product'] = 'Ethiopia Chelchele';
                  ...
                  <div class="product__price">
                    <p class="price text-gray-700 font-bold">
                      <?php 
                        $_SESSION['price'] = number_format(17.00, 2);
                        echo '$'.$_SESSION['price'];
                      ?>
                    </p>
                  </div>
              ...
              <div class="col-sm-100 w-1/2 lg:w-2/5 order-1">
                <div class="product__desc px-5 py-5">
                  <h3 class="heading-primary text-5xl">
                    Clean, elegant natural Ethiopian Yirgacheffe lot bursting with fruit flavors
                  </h3>

                  <p class="product__desc--para mt-5 ">
                    Sparkling is the first word that comes to mind for this natural processed Ethiopian. Grown in Yirgacheffe; a region known for yielding bright, delicate, and crisp coffees. When processed as a natural, (along with very immaculate attention to detail during sorting) these flavors give a juicy cup that retains an elegant, clean aftertaste. This Chelchele lot is grown at a high elevation of 1900-2100masl and in red soil, providing an ideal slightly acidic pH of 5.3-6.0 and is porous for better irrigation and air flow. The cherries are picked by hand to be perfectly ripe. The coffee is then sun-dried on raised beds.
                    Both our washed process Ethiopian Siko, and this natural processed coffee, are sourced through SNAP. As the exporter, they go above and beyond to provide training to all the smallholder farmers that drop off cherry to their washing stations. This coffee is purchased directly from the cooperative to provide more transparency in pricing and traceability.
                  </p>
                </div>
              </div>
