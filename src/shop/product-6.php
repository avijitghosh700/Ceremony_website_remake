              ...
              <div class="col-sm-100 w-1/2 lg:w-2/5">
                <div class="product__view px-5 py-5">
                  <img src=<?php $_SESSION['img'] = "../../images/new-10.jpg"; echo $_SESSION['img']; ?> 
                    alt=<?php $_SESSION['alt'] = "Origin Set"; 
              ...
              <div class="col-sm-100 w-1/2 lg:w-2/5 order-1">
                <div class="product__desc px-5 py-5">
                  ...
                  <p class="product__desc--para mt-5 ">
                    Two different 6 oz bags of the most incredible single origins we're roasting every other week. 
                    Perfect for your adventurous, non-committal, coffee-loving self (or friend!).
                    Our Roasting and Quality Control Teams will select our most dialed-in, 
                    delicious single-origin coffees to be shipped out for this subscription. 
                    The coffee selections are always the absolute best of our current line up as decided by our QC team, 
                    and each subscription is roasted and shipped whole bean every other Monday. 
                  </p>
                </div>
              </div>
