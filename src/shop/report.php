...
<html lang="en">
  <head>
    ...
    <title><?php echo 'Thank you for puchasing '.$_SESSION['product']; ?></title>
    ...
    <main class="main">
      <section class="orderDetail">
        <div class="container mx-auto px-6">
          ...
          <div class="orderDetail__orderReport border border-black px-5 py-5">
            <div class="orderDetail__row flex flex-wrap">
              <div class="col-xs-100 w-2/6 px-5 py-5">
                <div class="orderDetail__productImg">
                  <img src=<?php echo $_SESSION['img'] ?> 
                    alt=<?php echo str_replace(' ', '&nbsp;', $_SESSION['alt']); ?> 
                    class="orderDetail__productImg--img h-full w-full object-cover">
                </div>
              </div>

              <div class="col-xs-100 w-4/6 px-5 py-5">
                <div class="orderDetail__product">
                  <h4 class="heading-secondary text-5xl font-semibold">
                    <?php
                ...
                <div class="orderDetail__price mt-3">
                  <p class="price text-gray-700 font-bold">
                    <?php 
                      $price = $_SESSION['price'] * $_POST['quantity'];
                      echo '$'.number_format($price, 2);
                    ?>
                  </p>
                </div>

                <div class="orderDetail__customerDetail mt-10">
                  <p class="font-semibold">
                    <i class="fa fa-user-o fa-lg mr-2" aria-hidden="true"></i>
                ...
                <div class="orderDetail__address flex mt-10">
                  <i class="fa fa-map-marker fa-lg mr-2 pt-1" aria-hidden="true"></i>
                  <?php 
                    echo trim($_POST['userlocality'], ' ').', '.trim($_POST['userpo'], ' ').', '.trim($_POST['userps'], ' ').
                    ', '.trim($_POST['userdist'], ' ').', '.trim($_POST['userstate'], ' ').' - '.trim($_POST['userpin'], ' ');
                  ?>
                </div>
              </div>
            </div>
          ...
          <div class="orderDetail__btnGrp text-center mt-10">
            <a href="shop.html" class="btn btn__primary">continue shopping</a>
          </div>
        </div>
      </section>
    </main>
