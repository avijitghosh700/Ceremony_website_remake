            ...
            <div class="product__row flex flex-wrap">
              <div class="col-sm-100 w-1/2 lg:w-2/5">
                <div class="product__view px-5 py-5">
                  <img src=<?php $_SESSION['img'] = "../../images/new-4.jpg"; echo $_SESSION['img']; ?> 
                    alt= <?php $_SESSION['alt'] = "kenya thiururi"; 
              ...
              <div class="col-sm-100 w-1/2 lg:w-3/5">
                <div class="product__detail px-5 py-5">
                  <div class="product__title">
                    <p class="heading-sub uppercase">kiambu</p>
                    <h2 class="heading-secondary text-5xl md:text-6xl font-semibold">
                      <?php
                        $_SESSION['product'] = 'Kenya Thiururi';
                  ...
                  <div class="product__price">
                    <p class="price text-gray-700 font-bold">
                      <?php 
                        $_SESSION['price'] = number_format(18.00, 2);
                        echo '$'.$_SESSION['price'];
                      ?>
                    </p>
                  </div>
              ...
              <div class="col-sm-100 w-1/2 lg:w-2/5 order-1">
                <div class="product__desc px-5 py-5">
                  ...
                  <p class="product__desc--para mt-5 ">
                    Our Kenya Thiururi (THEE-OO-ROO-REE) is sourced in partnership with Nordic Approach importers. The work on the ground in Kenya involves cupping hundreds of lots, then visiting each factory and cooperative to fully understand the facility management. This helps us gain insight into quality control systems, consistency, and level of lot separation, as well as engage in a direct feedback loop - all to make we interact directly with the producers and ensure high quality year after year. Another priority of Nordic Approach is to work with co-ops that give a majority of the money back to the producers when the coffee is sold - 85% being the preferred level.
                  </p>
                </div>
              </div>
