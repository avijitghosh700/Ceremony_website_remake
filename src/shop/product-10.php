            ...
            <div class="product__row flex flex-wrap">
              <div class="col-sm-100 w-1/2 lg:w-2/5">
                <div class="product__view px-5 py-5">
                  <img src=<?php $_SESSION['img'] = "../../images/new-10.jpg"; echo $_SESSION['img']; ?> 
                    alt=<?php $_SESSION['alt'] = "Blend Set"; 
              ...
              <div class="col-sm-100 w-1/2 lg:w-3/5">
                <div class="product__detail px-5 py-5">
                  <div class="product__title">
                    <p class="heading-sub uppercase">subscription</p>
                    <h2 class="heading-secondary text-5xl md:text-6xl font-semibold">
                      <?php
                        $_SESSION['product'] = 'Blend Set';
                  ...
                  <div class="product__price">
                    <p class="price text-gray-700 font-bold">
                      <?php 
                        $_SESSION['price'] = number_format(100.00, 2);
                        echo '$'.$_SESSION['price'];
                      ?>
                    </p>
                  </div>
              ...
              <div class="col-sm-100 w-1/2 lg:w-2/5 order-1">
                <div class="product__desc px-5 py-5">
                  <h3 class="heading-primary text-5xl">
                    Send as a gift or receive for yourself.
                  </h3>

                  <p class="product__desc--para mt-5 ">
                    We frequently update our blends with vibrant, fresh coffees to keep every component singing in the major key of Delicious. This Blend Set subscription features a 12 oz bag of our tastiest blend at any given time. 
                    The blends in your shipments will occasionally repeat throughout the year but as transposed, 
                    seasonal interpretations of our house and espresso blends.
                    Shipping is included in the price of each subscription, 
                    and all subscriptions are limited to North America. Shipping to Canada and Mexico is additional. For prompt, precise shipping rates outside of the US, please contact us before placing your order.
                  </p>
                </div>
              </div>
