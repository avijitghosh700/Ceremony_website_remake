            ...
            <div class="product__row flex flex-wrap">
              <div class="col-sm-100 w-1/2 lg:w-2/5">
                <div class="product__view px-5 py-5">
                  <img src=<?php $_SESSION['img'] = "../../images/new-7.jpg"; echo $_SESSION['img']; ?> 
                    alt=<?php $_SESSION['alt'] = "Mexico Siltepec"; 
              ...
              <div class="col-sm-100 w-1/2 lg:w-3/5">
                <div class="product__detail px-5 py-5">
                  <div class="product__title">
                    <p class="heading-sub uppercase">chiapas</p>
                    <h2 class="heading-secondary text-5xl md:text-6xl font-semibold">
                      <?php
                        $_SESSION['product'] = 'Mexico Siltepec';
                  ...
                  <div class="product__price">
                    <p class="price text-gray-700 font-bold">
                      <?php 
                        $_SESSION['price'] = number_format(14.00, 2);
                        echo '$'.$_SESSION['price'];
                      ?>
                    </p>
                  </div>
              ...
              <div class="col-sm-100 w-1/2 lg:w-2/5 order-1">
                <div class="product__desc px-5 py-5">
                  ...
                  <p class="product__desc--para mt-5 ">
                    Historically, Mexican coffee has been sourced as an inexpensive, 
                    low-grown blender with characteristics described as "nutty" and "chocolate." 
                    This is due in large part to lower elevation, lack of governmental infrastructure, 
                    and being one of the countries hit hardest by the disease known as 'coffee leaf rust." 
                    However, with the spread of education, resource, and an eye on specialty quality, 
                    Mexican coffee can have extremely complex, soft citric acidity, 
                    and a balanced sweetness in the form of chocolate and caramel, all packed into a super clean cup.
                    In the early 20th century, 
                    large colonial estates were broken up in a government-lead land redistribution effort. 
                    This gave land back to the workers and indigenous communities, as well as enabled more small business opportunity, but also made it harder to sell the coffee. 
                    Most farmers own small of land averaging 1-5 hectares, 
                    making it harder to gain access to buyers and produce enough coffee to on their own. Strong community cooperatives, run as democratic associations, have become a viable solution.
                  </p>
                </div>
              </div>
