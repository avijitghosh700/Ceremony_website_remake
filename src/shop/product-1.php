            ...
            <div class="product__row flex flex-wrap">
              <div class="col-sm-100 w-1/2 lg:w-2/5">
                <div class="product__view px-5 py-5">
                  <img src=<?php $_SESSION['img'] = "../../images/new-1.jpg"; echo $_SESSION['img']; ?> 
                    alt= <?php $_SESSION['alt'] = "Costa Rica Nacientes Honey"; 
              ...
              <div class="col-sm-100 w-1/2 lg:w-3/5">
                <div class="product__detail px-5 py-5">
                  <div class="product__title">
                    <p class="heading-sub uppercase">single origin</p>
                    <h2 class="heading-secondary text-5xl md:text-6xl font-semibold">
                      <?php
                        $_SESSION['product'] = 'Costa Rica Nacientes Honey';
                  ...
                  <div class="product__price">
                    <p class="price text-gray-700 font-bold">
                      <?php 
                        $_SESSION['price'] = number_format(16.00, 2);
                        echo '$'.$_SESSION['price'];
                      ?>
                    </p>
                  </div>
              ...
              <div class="col-sm-100 w-1/2 lg:w-2/5 order-1">
                <div class="product__desc px-5 py-5">
                  ...
                  <p class="product__desc--para mt-5 ">
                    Marvin Monge Valverdes is a third generation producer, and with his son manages Finca Nacientes. 
                    They consider themselves "coffee lovers", not just producers. 
                    With that excitement comes the passion and responsibility 
                    to pass down their knowledge to peers and future generations.
                    Nacientes is part of a small, thirty producer project of the microlot mill "Palmichal" that started in 2015. 
                    The mission of Palmichal is to find producers with unique coffee, 
                    add to their work with exemplary processing, and pair the coffee with quality-minded roasters and buyers. 
                    This model allows for those discerning buyers to work directly with small farms to specify process 
                    and quantity needs, and offers full economical and physical transparency through the supply chain. 
                    Any premiums the mill achieves for quality goes back to the farmer directly.
                  </p>
                </div>
              </div>
